...
def add_base_options(parser):
    ...
    group.add_argument("--batch_size", default=2048, type=int, help="Batch size during training.")
...
def add_sampling_options(parser):
    ...
    group.add_argument("--autoregressive_init", default='data', type=str, choices=['data', 'isaac'], 
                        help="Sets the source of the init frames, either from the dataset or isaac init poses.")
    group.add_argument("--no_video", action="store_true", help="don't generate video for leftarm script")
...
def add_edit_options(parser):
    ...
    group.add_argument("--motion_length", default=9.8, type=float,
                       help="Desired total motion length in seconds (capped to dataset max).")
    ...
    group.add_argument("--suffix_start", default=None, type=float,
                       help="For in_between editing - Defines the start of input suffix (ratio from all frames). "
                            "If omitted, no suffix is kept and everything after the prefix will be inpainted.")
    group.add_argument("--zero_inpaint", action='store_true',
                       help="Skip dataset loading and feed an all-zero motion tensor as the inpaint source.")
    group.add_argument("--zero_length", default=120, type=int,
